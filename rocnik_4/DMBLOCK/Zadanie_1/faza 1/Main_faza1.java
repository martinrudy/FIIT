...
public class  Main_faza1 {
    ...
    public static void main(String[] args)
         ...
         */
        Tx tx = new Tx();
        tx.addOutput(5,  pk_bob.getPublicKey());
        tx.addOutput(5,  pk_bob.getPublicKey());
        ...
        utxoPool.addUTXO(utxo2, tx.getOutput(1));
        ...
        tx3.addOutput(1, pk_alice.getPublicKey());
        ...
        //System.out.println("handleTxs.txIsValid(tx2) returns: " + handleTxs.txIsValid(tx4));
        System.out.println("handleTxs.handler(new Transaction[]{tx2}) returns: "
                + handleTxs.handler(new Transaction[]{tx2, tx3, tx4}).length + " transaction(s)");
        System.out.println("handleTxs.handler(new Transaction[]{tx2}) returns: "
                + handleTxs.handler(new Transaction[]{tx2, tx3, tx4}).length + " transaction(s)");
    }
